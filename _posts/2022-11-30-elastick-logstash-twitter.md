...
![한글분석기코로나](C:\Users\이승환\Desktop\한글분석기코로나.png)
...
<img src="C:\Users\이승환\Desktop\시각화.png" alt="시각화" style="zoom: 80%;" />
...
1. 인덱스 패턴은 twitter_all 을 선택한다. 
2. 버킷 Aggregation 은 Terms 집계를 선택한다. 
3. Field는 해시태그가 저장된 해시태그(hashtags.text.keyword)를 선택한다.
4. 메트릭은 Count를 선택한다. 
